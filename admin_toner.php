...
if(isset($_GET['delete'])){
        ...
        or die('query failed');
            if($delete_query){
                 header('location:admin_toner.php');
...
<thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href = "admin_toner.php?delete=<?php echo $row['id']; ?>" class="delete-btn" 
                onclick="return confirm('Are you sure you want delete this?');"> 
                <i class="fas fa-trash"> </i> Delete </a>
                <a href = "admin_toner.php?edit=<?php echo $row['id']; ?>" class="option-btn" > 

    ...
    <table>
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="uploaded_img/<?php echo $fetch_cart['image']; ?>" height="120" alt="" ></td>             
                    ...
                    <td>RM  <?php echo $sub_total = (int) ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/=</td>
                ...
                <tr class = "table-bottom">
                    <td><a href="product_toner.php" class ="option-btn" style="margin-top: 0;">continue shopping</a>  </td>

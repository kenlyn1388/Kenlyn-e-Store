...
<thead>
    ...
    <tbody>
        ...
        <tr>
            <td> <img src= "uploaded_img/toner/<?php echo $row['image']; ?>" height="100" alt=""></td>
            <td><?php echo $row['name']; ?></td>
            <td>RM<?php echo $row['price']; ?>/=</td>
            <td>
                <a href = "userpage.php?delete=<?php echo $row['id']; ?>" class="delete-btn" 
                onclick="return confirm('Are you sure you want delete this?');"> 
                <i class="fas fa-trash"> </i> Delete </a>
                <a href = "userpage.php?edit=<?php echo $row['id']; ?>" class="option-btn" > 

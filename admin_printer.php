...
if(isset($_POST['add_product'])){
    ...
    $insert_query = mysqli_query($conn, "INSERT INTO `printer` (name, price, image) VALUES('$p_name', '$p_price', '$p_image')") 
        or die('query failed');
...
if(isset($_GET['delete'])){
        ...
        $delete_query = mysqli_query($conn, "DELETE FROM `printer` WHERE id = $delete_id") 
        or die('query failed');
            if($delete_query){
...
if(isset($_POST['update_product'])){
    ...
    $update_query = mysqli_query($conn, "UPDATE `printer` SET name = '$update_p_name', price = '$update_p_price', image ='$update_p_image' WHERE id = '$update_p_id'");
       if($update_query){
...
<thead>
    ...
    <tbody>
        <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `printer`");
        ...
        <tr>
            ...
            <td>
                <a href = "admin_printer.php?delete=<?php echo $row['id']; ?>" class="delete-btn" 
                onclick="return confirm('Are you sure you want delete this?');"> 
                <i class="fas fa-trash"> </i> Delete </a>
                <a href = "admin_printer.php?edit=<?php echo $row['id']; ?>" class="option-btn" > 
...
if(isset($_GET['edit']));
    ...
    $edit_id = $_GET['edit'];
    $edit_query = mysqli_query($conn, "SELECT * FROM  `printer` WHERE id = $edit_id");
